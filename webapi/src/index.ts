...
/*** スタブ ***/
const rememberPlayerIDResponse: RemenberPlayerIDResponse = { player_id: "R0000S0", event_player_id: "NoEntry" }
...
const room: CodableRoom = {players: players, board: board, inner_degree: 90, outer_degree: 180}
...
app.get('/api/roulette-poker/remenber-player-id', (req: express.Request, res: express.Response) => {
    res.json(rememberPlayerIDResponse)
})
app.get('/api/roulette-poker/join-room', (req: express.Request, res: express.Response) => {
    res.json(joinRoomResponse)
})
app.get('/api/roulette-poker/put-action', (req: express.Request, res: express.Response) => {
    res.json(putActionResponse)
})
app.get('/api/roulette-poker/bet-action', (req: express.Request, res: express.Response) => {
    res.json(betActionResponse)
})
app.get('/api/roulette-poker/scan-room', (req: express.Request, res: express.Response) => {
